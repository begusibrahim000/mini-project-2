...
<!-- 
	...
	<form action="{{ route('kategori_surats.update', $kategori->id) }}" method="POST">
        ...
        <input type="text" class="" name="kategori" value="{{ old('kategori', $kategori->kategori) }}" required>
        <button class="btn btn-success" type="submit">Update</button>
        <a class="btn btn-warning" href="{{route('kategori_surats.index')}}">Kembali ke halaman kategori</a>
	</form>
        </main>
    </div>
</body>
